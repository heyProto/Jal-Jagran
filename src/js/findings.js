...
function initScroll() {
    ...
    $(window).on('scroll', Util.throttle(function (event) {
        ...
        // console.log(container.height(), scrollTop, container.height() <== scrollTop, "asdadasdasd")

        // var sidebarSameHeightAsContainer = (container.height() === sidebar.outerHeight()) || ((container.offset().top + container.height()) <= (scrollTop + sidebar.height()))

        // if (!sidebarSameHeightAsContainer && sidebar.offset().top == 0) {
        //     position = 'fixed';
        // }
        ...
        //     });
        //     currentTop = Math.abs(sidebar.offset().top - scrollTop);
        // } else {
        //     sidebar.css({
        //         "position": position,
        //         "width": `${sidebarWidth}px`
    ...
    $(window).on('activate.bs.scrollspy', function (e) {
        ...
        //                     console.log("AAYA")
        //                     // debugger;
        //                     // var newTop = currentTop + (activeItem.height() + nextItem.height());
        //                     // currentTop = currentTop + (activeItem.height() + nextItem.height());

        //                     sidebar.css({ 'transform': `translateY(${scrollTop - sidebar.height()}px)` });
        //                 } else {
        //                     var newTop = currentTop + (activeItem.height() + nextItem.height());
        //                     currentTop = currentTop + (activeItem.height() + nextItem.height());

        //                     sidebar.css({ 'transform': `translateY(-${newTop}px)`});
        //                 }
        //             }
        //         }
        //         break;
        //     case "up":
        //         if (prevItem.length) {
        //             if (!prevItem.visible() && sidebar.css('position') !== "absolute") {
        //                 // var newTop = currentTop - (activeItem.height() + prevItem.height());
        //                 // currentTop = currentTop - (activeItem.height() + prevItem.height());
